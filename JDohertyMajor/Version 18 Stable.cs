    ...
    class Program
    {
       ...
       //Displays instructions to the user.
        ...
        public static void HighestData(string inFileName)
        {
            ...
            int stateUniversitiesArraySize = 0; //Count of universities in state
            int stateUniversitiesArrayIndex = 0; //The index of highest number
            ...
            try
            {
                ...
                for (int count = 0; count < admissionsArraySize; count++)
                    ...
                    {
                        stateUniversitiesArraySize++; //Determine required size
                    }

                int[] stateYearArray = new int[stateUniversitiesArraySize];
                for (int count = 0; count < stateUniversitiesArraySize; count++)
                {
                ...
                for (int count = 0; count < admissionsArraySize; count++)
                    if (admissionsData[count].universityState == stateChoice)
                    {
                        ...
                        {
                            case "2009":
                                stateYearArray[stateUniversitiesArrayIndex] = 
                                    admissionsData[count].admissionsNumber2009;
                                stateUniversitiesArrayIndex++;
                                break;
                            case "2010":
                                stateYearArray[stateUniversitiesArrayIndex] = 
                                    admissionsData[count].admissionsNumber2010;
                            ...
                            default:
                                Console.WriteLine
                                    ("stateYearArray failed to complete");
                                break;
                        }
                    }

                //Sort the array.
                Array.Sort(stateYearArray);
                Array.Reverse(stateYearArray);

                //Display the result to the user.
                Console.WriteLine
                    ("The highest number of applications for {0} in {1} is: "
                    + stateYearArray[0], stateChoice, yearChoice);
            }
            catch
            {
                Console.WriteLine("File read error");
