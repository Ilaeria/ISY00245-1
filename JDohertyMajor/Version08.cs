       ...
       //Displays instructions to the user.
            ...
            string outgoingFileName)
        {
            ...
            try
            {
                ...
                ////Count the number of lines in the incoming file.
                ...
                TempAdmissionsDetails[] tempAdmissionsData =
                    new TempAdmissionsDetails[ADMISSIONS_ARRAY_ENDING_LINE];
                ...
                for (int count = 0; count < ADMISSIONS_ARRAY_ENDING_LINE; count++)
                {
                    ...
                    if (stateCounter < STATE_ARRAY_SIZE)
                    {
                        ...
                        {
                            tempAdmissionsData[admissionsCounter].admissionsLine =
                                fileInput;
                            admissionsCounter++;
                        }
                    }
