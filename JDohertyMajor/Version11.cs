...
namespace JDohertyMajor
{
    class Program
    {
        ...
        public struct AdmissionsDetails
        {
            ...
            public string admissionsNumber2009; //Number of admissions in 2009
            public string admissionsNumber2010; //Number of admissions in 2010
            public string admissionsNumber2011; //Number of admissions in 2011
            public string admissionsNumber2012; //Number of admissions in 2012
            public string admissionsNumber2013; //Number of admissions in 2013
        }
       ...
       //Displays instructions to the user.
            ...
            string outgoingFileName)
        {
            ...
            for (int count = 0; count < admissionsArraySize; count++)
            {
                ...
                admissionsData[count].admissionsNumber2009 = "x";
                admissionsData[count].admissionsNumber2010 = "x";
                admissionsData[count].admissionsNumber2011 = "x";
                admissionsData[count].admissionsNumber2012 = "x";
                admissionsData[count].admissionsNumber2013 = "x";
            }
